...
fn main() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // S3 — first-launch onboarding: env preflight + warmup + role assign)
            ...
            // MEMUBOT Services
            uclaw_core::commands::memubot::services_health,
            uclaw_core::commands::memubot::memorization_status,
            uclaw_core::commands::memubot::proactive_status,
            uclaw_core::commands::memubot::proactive_start,
            uclaw_core::commands::memubot::proactive_stop,
            uclaw_core::commands::memubot::metrics_summary,
            uclaw_core::commands::memubot::memubot_config_get,
            uclaw_core::commands::memubot::get_plan_mode_suggest_enabled,
            uclaw_core::commands::memubot::set_plan_mode_suggest_enabled,
            uclaw_core::commands::memubot::get_stream_idle_timeout_secs,
            uclaw_core::commands::memubot::set_stream_idle_timeout_secs,
            // Bundle 17-B — /compact fold-delta threshold
            uclaw_core::commands::memubot::get_fold_delta_threshold,
            uclaw_core::commands::memubot::set_fold_delta_threshold,
            uclaw_core::commands::memubot::get_skill_prune_min_unused_days,
            ...
            // Browser Commands (Phase 3) → commands::browser_cmds (slice 9)
            uclaw_core::commands::browser_cmds::browser_get_state,
            uclaw_core::commands::browser_cmds::browser_launch,
            uclaw_core::commands::browser_cmds::browser_shutdown,
            uclaw_core::commands::browser_cmds::browser_take_screenshot,
            uclaw_core::commands::browser_cmds::browser_list_sessions,
            uclaw_core::commands::browser_cmds::browser_destroy_session,
            uclaw_core::commands::browser_cmds::browser_start_screencast,
            uclaw_core::commands::browser_cmds::browser_capture_screenshot,
            uclaw_core::commands::browser_cmds::browser_stop_screencast,
            uclaw_core::commands::browser_cmds::browser_get_dom_state,
            uclaw_core::commands::browser_cmds::browser_ui_navigate,
            uclaw_core::commands::browser_cmds::browser_ui_go_back,
            uclaw_core::commands::browser_cmds::browser_ui_go_forward,
            uclaw_core::commands::browser_cmds::browser_ui_switch_tab,
            uclaw_core::commands::browser_cmds::browser_ui_reload,
            uclaw_core::commands::browser_cmds::browser_ui_close_tab,
            uclaw_core::commands::browser_cmds::browser_ui_click,
            ...
            // Workspace Commands → commands::workspace (slice 10)
            uclaw_core::commands::workspace::get_active_workspace_id,
            uclaw_core::commands::workspace::set_active_workspace_id,
            uclaw_core::commands::workspace::create_workspace,
            uclaw_core::commands::workspace::update_workspace,
            uclaw_core::commands::workspace::get_workspace_skill_tags,
            uclaw_core::commands::workspace::set_workspace_skill_tags,
            uclaw_core::commands::workspace::reorder_workspaces,
            uclaw_core::commands::workspace::get_workspace_directories,
            uclaw_core::commands::workspace::attach_workspace_directory,
            uclaw_core::commands::workspace::detach_workspace_directory,
            uclaw_core::commands::workspace::list_session_directories,
            uclaw_core::commands::workspace::attach_session_directory,
            uclaw_core::commands::workspace::detach_session_directory,
            uclaw_core::commands::workspace::rename_attached_file,
            uclaw_core::commands::workspace::move_attached_file,
            uclaw_core::commands::workspace::read_attached_file,
            uclaw_core::commands::workspace::delete_workspace,
            uclaw_core::commands::workspace::list_directory_entries,
            uclaw_core::commands::workspace::search_workspace_files_for_mention,
            uclaw_core::commands::workspace::upload_workspace_file,
            uclaw_core::commands::workspace::copy_file_into_workspace,
            uclaw_core::commands::workspace::list_always_allowed_paths,
            uclaw_core::commands::workspace::add_always_allowed_path,
            uclaw_core::commands::workspace::remove_always_allowed_path,
            uclaw_core::commands::workspace::list_session_allowed_paths,
            uclaw_core::commands::workspace::promote_session_path_to_global,
            uclaw_core::commands::workspace::path_is_directory,
            uclaw_core::commands::workspace::delete_workspace_file,
            uclaw_core::commands::workspace::read_workspace_uclaw_md,
            uclaw_core::commands::workspace::write_workspace_uclaw_md,
            uclaw_core::commands::workspace::read_default_prompts,
            uclaw_core::commands::workspace::open_workspace_uclaw_md_externally,
            uclaw_core::commands::workspace::reveal_path_in_file_manager,
